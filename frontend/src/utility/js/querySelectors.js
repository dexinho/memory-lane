// Divs
export const userNameT = document.querySelector(".user-name-t");
export const timelinesDivT = document.querySelector("#timelines-div-t");
export const socialMediaLogin = document.querySelector("#social-media-login");
export const loginPopUpMsgT = document.querySelector("#login-pop-up-msg-t");
